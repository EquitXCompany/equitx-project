...
export class Analytics1739289022447 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."cdp_history_action_enum" AS ENUM('OPEN', 'ADD_COLLATERAL', 'WITHDRAW_COLLATERAL', 'BORROW_ASSET', 'REPAY_DEBT', 'FREEZE', 'LIQUIDATE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."staker_history_action_enum" AS ENUM('STAKE', 'UNSTAKE', 'DEPOSIT', 'WITHDRAW', 'CLAIM_REWARDS')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."staker_history_action_enum"`);
